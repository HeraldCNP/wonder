<ul class="sidebar-nav">
    ...
    <li>
        ...
        <ul>
            <li>
                <a href="{{ route('works.index') }}" class="{{ request()->is('works') ? 'active' : '' }}">Ver Todos <i class="fa fa-eye sidebar-nav-indicator sidebar-nav-mini-hide"></i></a>
            </li>
            <li>
                <a href="{{ route('works.create') }}">Agregar Nuevo <i class="fa fa-user-plus sidebar-nav-indicator sidebar-nav-mini-hide"></i></a>
            </li>
        </ul>
    </li>
    <li>
        <a href="#" class="sidebar-nav-menu {{ request()->is('companies*') ? 'active' : '' }}"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-building sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Empresas</span></a>
        <ul>
            <li>
                <a href="{{ route('companies.index') }}" class="{{ request()->is('companies') ? 'active' : '' }}">Ver Todos <i class="fa fa-eye sidebar-nav-indicator sidebar-nav-mini-hide"></i></a>
            </li>
            <li>
                <a href="{{ route('companies.create') }}">Agregar Nuevo <i class="fa fa-user-plus sidebar-nav-indicator sidebar-nav-mini-hide"></i></a>
            </li>
        </ul>
    </li>
    <li>
