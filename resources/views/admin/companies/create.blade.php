...
@section('content')
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Crear Nueva Empresa<br><small>En esta sección puede crear una nueva Empresa</small>
            </h1>
        </div>
    </div>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="contact" name="contact" placeholder="# de teléfono" value="{{ old('contact') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" id="web" name="web" placeholder="ej. (https://www.wondergroup.com.bo)" value="{{ old('web') }}">
                                @if ($errors->has('web'))
                                    <small class="form-text text-danger">
                                        {{ $errors->first('web') }}
                                    </small>
